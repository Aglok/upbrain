...
(function (h, c, e, a) {
    ...
    a.Augment({
        config: {
            styles: {
                ...
                ".MathJax_SVG_Display": {position: "relative", display: "block", width: "100%"},
                ".MathJax_SVG svg a > g, .MathJax_SVG_Display svg a > g": {fill: "blue", stroke: "blue"},
        ...
        Startup: function () {
            ...
            this.hiddenDiv = e.addElement(this.hiddenDiv, "div", {id: "MathJax_SVG_Hidden"});
            ...
            d = this.addElement(this.addElement(this.hiddenDiv.parentNode, "svg"), "defs", {id: "MathJax_SVG_glyphs"});
            f = {};
            ...
            this.linebreakSpan = e.Element("span", null, [["hr", {
                style: {
                    width: "auto",
                    size: 1,
                    padding: 0,
        ...
        preTranslate: function (o) {
            var t = o.jax[this.id], u, r = t.length, z, s, A, n, y, l, x, q, k, w = false, v, B = this.config.linebreaks.automatic, p = this.config.linebreaks.width;
            if (B) {
            ...
            for (u = 0; u < r; u++) {
                ...
                l.SVG = {display: (l.root.Get("display") === "block")};
                A = n = e.Element("span", {
                ...
                if (l.SVG.display) {
                    n = e.Element("div", {className: "MathJax_SVG_Display"});
                    n.appendChild(A)
                }
        ...
        Translate: function (l, p) {
            ...
            var k = l.MathJax.elementJax, o = k.root, m = document.getElementById(k.inputID + "-Frame"), q = (k.SVG.display ? m.parentNode : m);
        ...
        Zoom: function (l, s, q, k, p) {
            ...
            var r = s.offsetWidth, n = s.offsetHeight, t = q.offsetHeight, m = q.offsetWidth;
            s.style.position = q.style.position = "";
            return {Y: -EVENT.getBBox(s).h, mW: m, mH: t, zW: r, zH: n}
        },
        ...
        HandleVariant: function (s, r, C) {
            ...
            A = s;
            for (t = 0, q = C.length; t < q; t++) {
                s = A;
                o = C.charCodeAt(t);
                z = C.charAt(t);
                if (o >= 55296 && o < 56319) {
                    t++;
                    o = (((o - 55296) << 10) + (C.charCodeAt(t) - 56320)) + 65536;
                ...
                if (s.remap && s.remap[o]) {
                    if (s.remap[o] instanceof Array) {
                        var B = s.remap[o];
                        o = B[0];
                        s = this.FONTDATA.VARIANT[B[1]]
                    } else {
                        if (typeof(s.remap[o]) === "string") {
                            C = s.remap[o] + C.substr(t + 1);
                            t = 0;
                            q = C.length;
                            o = C.charCodeAt(0)
                        } else {
        ...
        createDelimiter: function (k, n, q, o) {
            ...
            for (var r = 0, p = l.HW.length; r < p; r++) {
                if (l.HW[r][0] * q >= n - 10 - a.config.blacker || (r == p - 1 && !l.stretch)) {
                    ...
                    return this.createChar(q, [k, l.HW[r][1]], o).With({stretched: true})
                }
            }
            if (l.stretch) {
        ...
        extendDelimiterV: function (r, A, m, o, n) {
            ...
            if (A > q) {
                ...
                while (p-- > 0) {
                    var t = a.Element("g", {transform: "translate(" + l.y + "," + (w - B * l.h + 50 + l.y) + ") scale(1," + B + ")"});
        ...
        extendDelimiterH: function (t, o, m, q, n) {
            ...
            if (o > B) {
                ...
                while (r-- > 0) {
                    var u = a.Element("g", {transform: "translate(" + (z - l / 2 - D * y.l + y.x) + "," + y.y + ") scale(" + D + ",1)"});
    ...
    var i = a.BBOX = MathJax.Object.Subclass({
        type: "g", removeable: true, Init: function (k) {
            ...
            l = ({left: l, center: (this.w - m.w) / 2, right: this.w - m.w - l})[n] || 0;
            this.Add(m, l, k)
        }, Clean: function () {
    ...
    i.RECT = i.Subclass({
        type: "rect", removeable: false, Init: function (l, n, k, m) {
            if (m == null) {
                m = {stroke: "none"}
            }
    ...
    i.FRAME = i.Subclass({
        type: "rect", removeable: false, Init: function (n, q, k, m, p, l, o) {
            if (o == null) {
                o = {}
            }
            o.fill = "none";
    ...
    i.HLINE = i.Subclass({
        type: "line", removeable: false, Init: function (l, p, r, o, q) {
            if (q == null) {
                q = {}
            }
            if (o && o !== "") {
            ...
            q.x2 = Math.floor(l);
            if (r === "dashed") {
                var s = Math.floor(l / (6 * p)), k = Math.floor(l / (2 * s + 1));
    ...
    i.VLINE = i.Subclass({
        type: "line", removeable: false, Init: function (p, o, r, l, q) {
            if (q == null) {
                q = {}
            }
            if (l && l !== "") {
            ...
            q.y2 = Math.floor(p);
            if (r === "dashed") {
                var s = Math.floor(p / (6 * o)), k = Math.floor(p / (2 * s + 1));
                q["stroke-dasharray"] = k + " " + k
            }
            this.SUPER(arguments).Init.call(this, q);
            this.w = this.r = o;
    ...
    i.TEXT = i.Subclass({
        type: "text", removeable: false, Init: function (n, m, k) {
            if (!k) {
                k = {}
            }
            k.stroke = "none";
    ...
    var f, d;
    i.GLYPH = i.Subclass({
        type: "path", removeable: false, Init: function (q, m, u, v, x, s, k, n) {
            var o, y = a.config.blacker;
            if (!f[m]) {
                o = {id: m, "stroke-width": y};
                if (n !== "") {
                    o.d = "M" + n + "Z"
                }
                this.SUPER(arguments).Init.call(this, o);
    ...
    c.Register.StartupHook("mml Jax Ready", function () {
        ...
        g.mbase.Augment({
            SVG: i, toSVG: function () {
                ...
                if (this["class"]) {
                    l.removeable = false;
                    a.Element(l.element, {"class": this["class"]})
                }
                if (this.id) {
                    l.removeable = false;
                    a.Element(l.element, {id: this.id})
                }
                if (this.href) {
                    var k = a.Element("a");
                ...
                if (a.config.addMMLclasses) {
                    l.removeable = false;
                    l.element.setAttribute("className", "mjx-svg-" + this.type)
                }
                var m = this.style;
                if (m && l.element) {
                ...
                if (this.style) {
                    ...
                    this.styles = {border: a.getBorders(k), padding: a.getPadding(k)};
                    if (k.style.fontSize) {
                ...
                if (w.mathcolor) {
                    a.Element(o.element, {fill: w.mathcolor, stroke: w.mathcolor});
                    o.removeable = false
                }
                var s = (this.styles || {}).border, u = (this.styles || {}).padding, t = ((s || {}).left || 0), q = ((u || {}).left || 0), k;
                ...
                if (w.background !== g.COLOR.TRANSPARENT) {
                    ...
                    o.Add(i.RECT(o.h, o.d, o.w, {fill: w.background, stroke: "none"}), 0, 0, false, true)
                }
                if (s) {
                    var v = 5;
                    var m = {
                ...
                var l = 1, k = this.getValues("mathsize", "scriptlevel", "fontsize");
        ...
        g.mo.Augment({
            toSVG: function (l, k) {
                ...
                var p = this.SVGgetScale(), r = this.SVGgetVariant();
                var z = this.getValues("largeop", "displaystyle");
                if (z.largeop) {
                    r = a.FONTDATA.VARIANT[z.displaystyle ? "-largeOp" : "-smallOp"]
                }
                var y = this.CoreParent(), q = (y && y.isa(g.msubsup) && this !== y.data[0]), n = (q ? this.SVGremapChars : null);
                ...
                for (var s = 0, o = this.data.length; s < o; s++) {
                    if (this.data[s]) {
                        var A = this.data[s].toSVG(r, p, this.SVGremap, n), v = t.w;
                        if (v === 0 && -A.l > 10 * A.w) {
                            v += -A.l
                        }
                        t.Add(A, v, 0, true);
                ...
                if (z.largeop) {
                    t.y = (t.h - t.d) / 2 / p - a.TeX.axis_height;
                    if (t.r > t.w) {
                        t.ic = t.r - t.w;
                        t.w = t.r
                    }
            ...
            SVGstretchV: function (p, q) {
                ...
                var o = a.TeX.axis_height, k = this.SVGgetMu(m), n;
                if (l.symmetric) {
        ...
        g.mtext.Augment({
            toSVG: function () {
                this.SVGgetStyles();
                var k, o, n = this.SVGgetScale();
                if (this.Parent().type === "merror") {
                    k = this.SVG();
                    this.SVGhandleSpace(k);
                    o = i.G();
                    o.Add(i.TEXT(0.9 * n, this.data.join(""), {fill: "#C00"}));
                    k.Add(i.RECT(o.h + 100, o.d + 100, o.w + 200, {
                        fill: "#FF8",
                        stroke: "#C00",
                        "stroke-width": 50
                    }), 0, 0);
        ...
        g.mspace.Augment({
            toSVG: function () {
                ...
                var l = this.SVG(), k = this.SVGgetMu(l);
        ...
        g.mpadded.Augment({
            toSVG: function (l, k) {
                ...
                if (this.data[0] != null) {
                    ...
                    var m = this.SVGdataStretched(0, l, k), u = this.SVGgetMu(o);
                    var t = this.getValues("height", "depth", "width", "lspace", "voffset"), r = 0, q = 0;
                    if (t.lspace) {
        ...
        g.mfrac.Augment({
            toSVG: function () {
                ...
                var s = this.data[0].toSVG(), y = this.data[1].toSVG();
                var C = this.getValues("displaystyle", "linethickness", "numalign", "denomalign", "bevelled");
                var r = w.scale = this.SVGgetScale(), n = C.displaystyle;
                ...
                if (C.bevelled) {
                    ...
                    var E = a.thickness2em(C.linethickness, r), m, l, D, z;
        ...
        g.mroot.Augment({
            toSVG: g.msqrt.prototype.toSVG, SVGaddRoot: function (n, l, q, o, k) {
        ...
        g.munderover.Augment({
            toSVG: function (F, C) {
                ...
                var o = p[this.base] || {w: 0, h: 0, d: 0, H: 0, D: 0, l: 0, r: 0, scale: M};
        ...
        g.msubsup.Augment({
            toSVG: function (G, z) {
                ...
                var C = a.TeX.sup_drop * l, A = a.TeX.sub_drop * l;
                var w = m.h + (m.y || 0) - C, o = m.d - (m.y || 0) + A, J = 0, F;
                if (m.ic) {
                    m.w -= m.ic;
                    J = 1.3 * m.ic + 0.05
                }
        ...
        g.math.Augment({
            SVG: i.Subclass({type: "svg", removeable: false}), toSVG: function (t, m) {
                if (this.data[0]) {
                    this.SVGgetStyles();
                    ...
                    s.Clean();
                    this.SVGsaveData(s);
                    var p = Math.max(-s.l, 0), k = Math.max(s.r - s.w, 0);
